  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>P.kax Admin</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="${cp }/code/countryCode">ContryCode</a></li>
                          <li><a  href="${cp }/code/crawlerInfo">CrawlerInfo</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Crawler Table</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      ...
                      <h4><i class="fa fa-angle-right"></i> CountryCode Table</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th>useYn</th>
                                  <th>code</th>
                                  <th class="numeric">codeSec</th>
                              </tr>
                              </thead>
                              <tbody>
                              <c:forEach items="${ccTable }" var="cc">
                              <tr>
								 <td class="code_data">${cc.name}</td>
								 <td class="code_data editable toggle">${cc.useYn }</td>
								 <td class="code_data">${cc.code }</td>
								 <td class="code_data">${cc.codeSec }</td>	                              
                              </tr>
                              </c:forEach>
                              </tbody>
                          </table>
	...
	<!--custom switch-->
	<script src="${cp}/assets/js/bootstrap-switch.js"></script>
	
	<!--custom tagsinput-->
	<script src="${cp}/assets/js/jquery.tagsinput.js"></script>
	
	<!--custom checkbox & radio-->
	
	<script type="text/javascript" src="${cp}/assets/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="${cp}/assets/js/bootstrap-daterangepicker/date.js"></script>
	<script type="text/javascript" src="${cp}/assets/js/bootstrap-daterangepicker/daterangepicker.js"></script>
	
	<script type="text/javascript" src="${cp}/assets/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
	
	
	<script src="${cp}/assets/js/form-component.js"></script>    
		  ...
		  $(".code_data.editable").each(function(k,v){
			  if($(this).hasClass('toggle')){
				  ...
				  if(this_var=='Y'||this_var=='y'||this_var=='T'||this_var=='True'||this_var=='1'){
					  toggleYn = true;
					  toggleHtml = '<div class="switch has-switch"><div class="switch-on switch-animate"><input type="checkbox" checked="" data-toggle="switch"><span class="switch-left">ON</span><label>&nbsp;</label><span class="switch-right">OFF</span></div></div>'
				  }else
					  toggleHtml = '<div class="switch has-switch"><div class="switch-off switch-animate"><input type="checkbox" checked="" data-toggle="switch"><span class="switch-left">ON</span><label>&nbsp;</label><span class="switch-right">OFF</span></div></div>'
				  //break;
