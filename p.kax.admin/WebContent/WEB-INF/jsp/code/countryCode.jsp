                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
								 ...
								 <td class="code_data editable toggle" data-name="useYn" data-seq="${cc.codeSec }" data-value="">${cc.useYn }</td>
	...
	$("#editActivateBtn").click(function(){
		  ...
		  $(".code_data.editable").each(function(k,v){
			  ...
			  if($(this).hasClass('toggle')){
				  ...
				  formHtml = '<input type="text" class="form-control" value='+this_var+'>';
			  }
			  $(this).html(formHtml);
		  })
	  })
	  ...
	  $("#editCommitBtn").click(function(){
		  ...
		  $(".data-edited").each(function(){
			  ...
			  dataSet.menu = "countryCode";
			  dataSet.seq_name = "codeSec"
