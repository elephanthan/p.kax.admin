              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="${cp }/code/currency">Currency</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Crawler Tables</h3>
		  		<div class="row mt">
                      ...
                      <h4><i class="fa fa-angle-right"></i> Currency Table</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>code</th>
                                  <th class="numeric">currencySeq</th>
                                  <th>name</th>
                                  <th class="numeric">rate</th>
                                  <th>time</th>
                                  <th class="numeric">ask</th>
                                  <th class="numeric">bid</th>
                              </tr>
                              </thead>
                              <tbody>
                              <c:forEach items="${cuTable }" var="cu">
                              <tr>
								 <td class="code_data editable" data-name="code" data-seq="${cu.currencySeq }" data-value="">${cu.code}</td>
								 <td class="code_data">${cu.currencySeq}</td>
								 <td class="code_data editable" data-name="name" data-seq="${cu.currencySeq }" data-value="">${cu.name}</td>
								 <td class="code_data editable" data-name="rate" data-seq="${cu.currencySeq }" data-value="">${cu.rate}</td>
								 <td class="code_data">${cu.time}</td>
								 <td class="code_data editable" data-name="ask" data-seq="${cu.currencySeq }" data-value="">${cu.ask}</td>
								 <td class="code_data editable" data-name="bid" data-seq="${cu.currencySeq }" data-value="">${cu.bid}</td>	                              
                              </tr>
                              </c:forEach>
                              </tbody>
                          </table>
	...
	$("#editActivateBtn").click(function(){
	  ...
	  $("#editCommitBtn").click(function(){
		  ...
		  $(".data-edited").each(function(){
			  ...
			  dataSet.menu = "currency";
			  dataSet.seq_name = "currencySeq"
