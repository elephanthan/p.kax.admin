...
import ssu.pickax.vo.Pagination;
...
public class ApiPaginationListVo<T> {
	...
	public ApiPaginationListVo(List<T> list, Pagination paginationInfo) {
		...
		this.item_count = paginationInfo.getTotal_item_num();
		this.page_count = paginationInfo.getTotal_page_num();
		this.result = paginationInfo.getPage_per_item_num();
		this.present_page = paginationInfo.getPresent_page();
	}
